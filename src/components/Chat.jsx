...
const Chat = () => {
  ...
  const chatClass = classNames(
    "fixed top-14 bg-gray-100 inset-x-0 xl:left-[75rem] top-16 w-[90%] md:w-[60%] xl:w-[21%] mx-auto xl:mx-0 rounded-lg z-50 flex flex-col p-6 max-h-[600px] overflow-y-auto dark:bg-main-dark-bg",
    { "animate-opacityAnimation": chatAnimationEffect }
  );
  return (
    <div className={chatClass}>
      <div className="flex gap-x-3">
        <h2 className="font-semibold dark:text-white">Messages</h2>
        <p
