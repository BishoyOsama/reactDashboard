...
const Notification = () => {
  ...
  const notificationClass = classNames(
    "fixed top-14 bg-gray-100 inset-x-0 xl:left-[78rem] top-16 w-[90%] md:w-[60%] xl:w-[21%] mx-auto xl:mx-0 rounded-lg z-50 flex flex-col p-6 max-h-[600px] overflow-y-auto ",
